...
<div className="container">
  ...
  <div className="row">
    <div className="col-12 col-lg-5 ">
      <img src={ props.MainImg } className="img-thumbnail imgMaior"/>

      <div className="row miniImg">
        <div className="col-3">
          <img src={ props.miniImg1 } className="img-thumbnail" /> 
        </div>
        <div className="col-3">
          <img src={ props.miniImg2 }  className="img-thumbnail"  />
        </div>
        <div className="col-3">
          <img src={ props.miniImg3 } className="img-thumbnail" />
        </div>
