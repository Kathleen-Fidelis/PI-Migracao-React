...
// if(data.value.length == 6 == 2 && data.value.length == 7 == 0 && data.value.length == 8 == 0 && data.value.length == 9 == 4){
//   return false;
// }else if(data.value.length == 6 == 2 && data.value.length == 7 == 0 && data.value.length == 8 == 0 && data.value.length == 9 > 4){
//   return false;
// }
                    ...
                    <div className="card card-input mb-4">
                      ...
                      <div className="form-group font-weight-bold mb-2 mt-3 col-11 custom-input">
                        <label className="mb-2" htmlFor="emailConfirma">
                          ...
                          <FontAwesomeIcon
                            icon={faCheck}
                            className={email === matchEmail && matchEmail !== "" ? "valid" : "hide"}
                          />
                          
                          <FontAwesomeIcon
                            icon={faTimes}
                            className={
                              email !== matchEmail  ? "invalid" : "hide"
                            }
                          />
                        </label>
                        <input
