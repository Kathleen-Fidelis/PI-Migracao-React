    ...
    return (
        <>
            ...
            <div id="BodyPrincipal">
                ...
                <p></p>
                <p className="lh-base bolder">1.1 Conforme prevê o Código de Defesa do Consumidor, Artigo 26, a PIMPOLHOS realizará a troca dos produtos adquiridos por seus clientes, desde que seja constatado vício ou defeito em até 90 dias da data do recebimento, devendo o cliente, obr/igatoriamente, comunicar a Equipe de Atendimento através dos canais Email sac@pimpolhos.com.br/ ou na Guia Atendimentos disponíveis no website e seguir as instruções recebidas para que o pedido de troca seja analisado e processado.</p>
                <p className="text-start fw-light"> a) Desprendimento espontâneo de membr/os ou cabeça do corpo da boneca, exceto no caso de segurar a Bebê pelos membr/os ou cabeça ou qualquer outro movimento agressivo.</p>
                ...
                <p className="lh-base bold"> <b className="garantia">A garantia não cobr/e problemas ocasionados por má utilização da boneca, vide Manual de Cuidados </b>, ou seja, quando a sua utilização é diversa da proposta do produto. Por exemplo: uma Boneca Bebê Reborn de Pano não é adequada ao banho, e caso isso ocorra, não haverá garantia.</p>
                <br />
                ...
                <p className="lh-base bold">2.1.2 O pedido de desistência passará por uma avaliação, para verificar se houve o atendimento dos requisitos acima e se tal(is) produto(s) não foi/foram utilizado(s) ou danificado(s), mesmo que parcialmente. Caso alguma destas situações tenha ocorrido, a devolução não será aceita e a PIMPOLHOS não tem a obr/igação de aceitar.</p>
