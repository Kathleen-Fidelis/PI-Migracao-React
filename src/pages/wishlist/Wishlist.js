...
function Wishlist() {
    return (
        <>
            <Header />
            <div className="container navtabContainer">
                ...
                <ul className="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li className="nav-item principal" role="presentation">
                        <button className="nav-link principal active col-12" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                            ...
                            <img className="emotes" src="./images/user.png"/>Minha Conta</button>
                    </li>
                    ...
                    <li className="nav-item principal" role="presentation">
                        <button className="nav-link principal col-12 " id="pedidos-tab" data-bs-toggle="tab" data-bs-target="#MeusPedidos"
                            ...
                            <img className="emotes" src="./images/checklist.png"/> Meus Pedidos</button>
                    </li>
                    ...
                    <li className="nav-item principal" role="presentation">
                        <button className="nav-link principal" id="desejos-tab" data-bs-toggle="tab" data-bs-target="#ListadeDesejos"
                            type="button" role="tab" aria-controls="desejos" aria-selected="false"> <img className="emotes"
                ...
                <div className="tab-content" id="myTabContent">
                    <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div className="tab-pane fade" id="ListadeDesejos" role="tabpanel" aria-labelledby="desejos-tab">
